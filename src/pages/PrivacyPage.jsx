    ...
    <div className="section-shell mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-10">
      ...
      <section className="card space-y-5 text-sm leading-7 text-slate-700">
        <div>
          ...
          <p className="mt-1">주간 식단과 식사 인원·기피 재료·식사일 설정은 로그인 여부와 관계없이 현재 브라우저에만 저장되며, 게스트와 계정별로 분리합니다. 식단은 서버 동기화와 데이터 내려받기에 포함되지 않습니다.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="mt-1">
            ...
            확인한 뒤 계정을 삭제하면 운영 데이터베이스의 계정과 연결 데이터, 해당 기기의 계정 전용 재료 캐시·오늘 메뉴 선택·주간 식단을
