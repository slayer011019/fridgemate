          ...
          <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
            <div className="min-w-0">
              ...
              <div className="mt-1 flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between sm:gap-4">
                <div>
                  <h1 className="text-lg font-semibold tracking-tight text-slate-900 sm:text-[1.25rem]">
            ...
            <div className="flex min-w-0 shrink-0 flex-col gap-2 lg:flex-row lg:flex-wrap lg:items-center lg:justify-between xl:justify-end">
              <nav className="glass-card touch-pan-x flex w-full max-w-full items-center gap-1.5 overflow-x-auto p-1.5 lg:w-auto">
              ...
              <div className="flex w-full flex-wrap items-center gap-2 rounded-full border border-white/75 bg-white/72 px-2 py-2 shadow-sm lg:w-auto">
                {isAuthenticated ? (
                  <>
