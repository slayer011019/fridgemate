      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="soft-panel">
            ...
            <p className="mt-3 text-2xl font-semibold text-slate-900">{recipe.scoreLabel || '-'}</p>
          ...
          <div className="soft-panel border-brand-100/70 bg-brand-50/60">
            ...
            <p className="mt-1 text-xs muted">{joinIngredientLabels(recipe.matchedIngredients) || '\uC544\uC9C1 \uC5C6\uC5B4\uC694'}</p>
          </div>
          <div className="soft-panel border-rose-100/80 bg-rose-50/70">
            ...
            <p className="mt-1 text-xs muted">{joinIngredientLabels(recipe.missingIngredients) || '\uBD80\uC871\uD55C \uC7AC\uB8CC \uC5C6\uC74C'}</p>
          </div>
        </div>
        ...
        <div className="grid gap-3">
          ...
          {recipe.expiringMatchedIngredients?.length ? (
            <div className="rounded-[22px] border border-amber-200/70 bg-amber-50/80 p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-amber-900">{joinIngredientLabels(recipe.expiringMatchedIngredients)}</p>
            </div>
          ) : null}
        </div>
      </div>
