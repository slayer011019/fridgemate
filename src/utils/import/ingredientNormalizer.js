...
const CANONICAL_RULES = [
  ...
  { keywords: ['고추', '청양고추', '홍고추'], normalizedName: '고추', category: '채소', storageType: STORAGE_FRIDGE },
  { keywords: ['양송이'], normalizedName: '버섯', category: '채소', storageType: STORAGE_FRIDGE },
  { keywords: ['느타리버섯', '표고버섯', '새송이버섯', '팽이버섯', '버섯'], normalizedName: '버섯', category: '채소', storageType: STORAGE_FRIDGE },
  ...
  { keywords: ['참치캔'], normalizedName: '통조림', category: '상온식품', storageType: STORAGE_PANTRY },
  ...
  { keywords: ['만두', '볶음밥', '아이스크림', '왕교자', '피자', '핫도그', '돈까스', '너겟'], normalizedName: '냉동식품', category: '냉동식품', storageType: STORAGE_FREEZER },
  { keywords: ['햄', '베이컨', '소시지'], normalizedName: '가공육', category: '육류', storageType: STORAGE_FRIDGE },
  { keywords: ['스팸', '참치캔', '옥수수캔', '복숭아캔', '황도캔'], normalizedName: '통조림', category: '상온식품', storageType: STORAGE_PANTRY },
  { keywords: ['라면', '국수', '우동', '파스타', '스파게티', '소면'], normalizedName: '면', category: '간편식', storageType: STORAGE_PANTRY },
  ...
  { keywords: ['즉석국', '즉석탕', '사골곰탕'], normalizedName: '즉석국', category: '간편식', storageType: STORAGE_PANTRY },
